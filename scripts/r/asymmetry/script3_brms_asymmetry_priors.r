...
# 1. To load
finalModel_prior <- readRDS("c:/Users/j_m289/Pictures/phd/3. Data Analysis/studies/OKTOS/resting_te/analysis/brms/models/asymmetry/asymmetry_finalmodel_prior.rds") # adjust filename as required
...
## ---- Export figures -------------------------------------------------
ggsave("c:/Users/j_m289/Pictures/phd/3. Data Analysis/studies/OKTOS/resting_te/analysis/brms/figures/asymmetry_prior_pp_check.jpeg", plot = fig1, width = 10, height = 10)